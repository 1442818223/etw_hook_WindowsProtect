...
int GetUserFindWindowExIndex()
{
	...
	if (number == 7)
	{ 
		FuncName = "SetThreadDesktop";   //找到上面导出的定位下面没导出的
	}
	else
	{
...
int GetUserQueryWindowIndex()
{
	...
	//index = GetFuncIndexPlus(FuncName,0x65, 1);   Win11不用减 直接能找到
	index = GetFuncIndex(FuncName,0x11);  //参数二不管写多少在自己写的底层函数ReadIndex都会根据版本矫正
	return index;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
